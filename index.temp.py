...
situps_button = Button("Crunches", screen_width // 2 - button_width // 2, 200, button_width, button_height, action=crunch_action)
pushups_button = Button("Pushups", screen_width // 2 - button_width // 2, 500, button_width, button_height, action=pushups_action)
squats_button = Button("Squats", screen_width // 2 - button_width // 2, 800, button_width, button_height, action=squats_action)
